BEGIN TRANSACTION;
 -- ========================= -- TABLE MARQUE -- =========================
INSERT INTO marque (marque) SELECT 'DeLonghi' WHERE NOT EXISTS(SELECT 1 FROM marque WHERE marque='DeLonghi');
INSERT INTO marque (marque) SELECT 'Philips' WHERE NOT EXISTS(SELECT 1 FROM marque WHERE marque='Philips');
INSERT INTO marque (marque) SELECT 'Saeco' WHERE NOT EXISTS(SELECT 1 FROM marque WHERE marque='Saeco');
INSERT INTO marque (marque) SELECT 'Krups' WHERE NOT EXISTS(SELECT 1 FROM marque WHERE marque='Krups');

-- ========================= -- TABLE COMMERCANT -- SINGLE_TABLE inheritance -- colonne discriminator = typeCommercant -- =========================
...
SELECT 'Distributeur', '12 rue du Café, Paris', 'contact@cafes-paris.fr', 'Cafés de Paris', 'https://www.cafes-paris.fr', '0102030405', NULL, 'COOPERATIVE U'
